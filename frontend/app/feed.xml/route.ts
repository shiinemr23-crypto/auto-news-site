...
export async function GET() {
  ...
  return new Response(`<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>Wireline</title><link>${escape(base)}</link><description>AI-assisted summaries and multi-source global news briefings.</description>${body}</channel></rss>`, { headers: { "Content-Type": "application/rss+xml; charset=utf-8", "Cache-Control": "public, s-maxage=300, stale-while-revalidate=600" } });
}
